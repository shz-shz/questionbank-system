...
blanks.style.display = 'none' //默认不显示填空题答案输入框

type.children[1].addEventListener('click', function () { //选择单选按钮
    answers.style.display = 'block' //显示单选题答案输入
    answer_text.style.display = 'none' //隐藏简答题答案输入
    blanks.style.display = 'none' //隐藏填空题答案输入
    ...
    blanks.children[1].removeAttribute('name') //去除填空题的name属性防止提交
    blanks.children[3].removeAttribute('name')
    blanks.children[5].removeAttribute('name')
    blanks.children[7].removeAttribute('name')
...
type.children[3].addEventListener('click', function () {
    ...
    answer_text.style.display = 'none' //隐藏简答题答案输入
    blanks.style.display = 'block' //显示填空题答案输入
    ...
    blanks.children[1].setAttribute('name', 'answerA') //将填空题答案输入加上name属性进行提交
...
type.children[5].addEventListener('click', function () { //选择简答按钮
    answers.style.display = 'none' //隐藏单选题答案输入
